...
Web Scraping - get data from finviz and output to a file
@author: tomfoolc
"""
...
for ticker in tickerList:
    ...
    data.append([perfReturn.get("Ticker"),perfReturn.get("Month Return"),
                 perfReturn.get("Quarter Return"),perfReturn.get("Half Year Return"),
                 perfReturn.get("Year Return")])

header = ["Ticker","Month Return","Quarter Return","Half Year Return","Year Return"]

"""
#open the file in the writer mode
f = open("./adm.csv","w",encoding="UTF8",newline="")
